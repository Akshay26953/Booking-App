      ...
      <div className={type === "list"? "headerContainer listMode":"headerContainer"}>
        ...
        <div className="headerSearch">
          ...
          <div className="headerSearchItem">
            ...
            {openDate && <DateRange editableDateInputs={true} onChange={(item) => setDates([item.selection])} moveRangeOnFirstSelection={false} minDate={new Date()} ranges={dates} className="date" />}
          </div>
          <div className="headerSearchItem">
            ...
            {openOptions && <div className="options">
              <div className="optionsItem">
                ...
                <div className="optionCounter">
                  <button disabled={options.adult <= 1 } className="optionCounterButton" onClick={()=> handleCounter('adult', 'd')}>-</button>
              ...
              <div className="optionsItem">
                ...
                <div className="optionCounter">
                  <button disabled={options.room <= 1 } className="optionCounterButton" onClick={()=> handleCounter('room', 'd')}>-</button>
